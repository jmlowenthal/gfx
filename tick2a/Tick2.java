...
public class Tick2 {
    ...
    public static final int DEFAULT_BOUNCES = 8;
	public static final int DEFAULT_SAMPLES = 8;
    ...
    public static void main(String[] args) throws IOException {
        ...
        int bounces = DEFAULT_BOUNCES, samples = DEFAULT_SAMPLES;
		int width = WIDTH_PX, height = HEIGHT_PX;
        ...
        BufferedImage image = new Renderer(width, height, bounces, samples).render(scene);
